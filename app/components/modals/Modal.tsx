...
const DialogContent = React.forwardRef<
    ...
    <DialogPortal>
        ...
        <DialogPrimitive.Content
            ref={ref}
            className={cn(
                "fixed left-[50%] top-[50%] z-50 grid translate-x-[-50%] translate-y-[-50%] gap-4 bg-background-secondary p-4 sm:p-8 shadow-lg duration-200 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[state=closed]:slide-out-to-left-1/2 data-[state=closed]:slide-out-to-top-[48%] data-[state=open]:slide-in-from-left-1/2 data-[state=open]:slide-in-from-top-[48%] rounded-xl",
                className
            )}
            {...props}
            >
            <div className="flex flex-row items-center mb-4 sm:mb-8 w-full justify-between">
                <DialogHeader>
                    <DialogTitle>
                        <p className="text-base sm:text-[34px] items-center justify-between w-full leading-6 sm:leading-9">{props.title}</p>
                    </DialogTitle>
                </DialogHeader>
